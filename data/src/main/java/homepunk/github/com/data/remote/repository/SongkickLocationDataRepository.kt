...
class SongkickLocationDataRepository @Inject constructor(private var songkickApi: SongkickApi) : SongkickLocationRepository {
    ...
    override fun getSongkickLocationByQuery(query: String): Observable<UserLocation> =
            Observable.defer {
    ...
    override fun getSongkickLocationByLatLng(latLng: String): Observable<UserLocation> =
