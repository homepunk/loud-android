package homepunk.github.com.presentation.feature.widget.searchview;
...
import static homepunk.github.com.presentation.feature.widget.searchview.MaterialSearchToLine.State.LINE;
import static homepunk.github.com.presentation.feature.widget.searchview.MaterialSearchToLine.State.RUNNING;
import static homepunk.github.com.presentation.feature.widget.searchview.MaterialSearchToLine.State.SEARCH;
...
public class MaterialSearchToLine extends View implements ValueAnimator.AnimatorUpdateListener {
    ...
    protected void resetLayout(int left, int top, int right, int bottom) {
        ...
        int h = drawBottom - drawTop - 4;
        float r = 0;
        mTouchRect.set(drawRight - h, drawTop, drawRight, drawBottom);
        // sin45 * 2R + R = height
        r = (float)(h / (sin45 * 2 + 1));
        rx = (float)(drawRight - 2 * r * sin45 - 4);
        ry = r + drawTop - 4;
