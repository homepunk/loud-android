...
import homepunk.github.com.presentation.databinding.LayoutItemLatestReleaseBinding
...
class LatestReleaseListRecyclerAdapter : RecyclerView.Adapter<ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = LayoutItemLatestReleaseBinding.inflate(inflater)
        return ViewHolder(binding)
    }

    inner class ViewHolder(val binding: LayoutItemLatestReleaseBinding) : RecyclerView.ViewHolder(binding.root) {
